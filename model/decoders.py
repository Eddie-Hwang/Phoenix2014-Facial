...
from model.attention import BahdanauAttention, LuongAttention
from model.encoders import Encoder
from model.helpers import freeze_params, subsequent_mask
from model.transformer_layers import PositionalEncoding, TransformerDecoderLayer
...
class TransformerDecoder(Decoder):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # output layer to produce actual target dimension
        self.output_layer = nn.Linear(hidden_size, target_size, bias=False)
