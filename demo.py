...
test_image = './PHOENIX-2014-T/features/fullFrame-227x227px/train/22November_2011_Tuesday_tagesschau-3649/images0028.png'
oriImg = cv2.imread(test_image)  # B,G,R order

oriImg = cv2.resize(oriImg, dsize=(420, 420), interpolation=cv2.INTER_AREA)
